...
#PBS -l mem=16gb
#PBS -t 1,17,35,44,53,62,71,80,89,98,107,116,125,134
#PBS -o logs/out.log
...
/appl/glibc/2.17/lib/ld-linux-x86-64.so.2  --library-path /appl/glibc/2.17/lib/:/appl/gcc/4.8.5/lib64/:/lib64:/usr/lib64:$LD_LIBRARY_PATH $(which python) trainNFTreceiver.py -n $PBS_ARRAYID >> logs/NN-log-$PBS_ARRAYID.txt
